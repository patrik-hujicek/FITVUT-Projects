...
\projectinfo{
  ...
  title.cs={Hybridná chatovacia P2P sieť},  %nazev prace v cestine ci slovenstine (dle zadani) / thesis title in czech language (according to assignment)
  title.en={Hybrid P2P network for chatting}, %nazev prace v anglictine / thesis title in english
  %Autor / Author
