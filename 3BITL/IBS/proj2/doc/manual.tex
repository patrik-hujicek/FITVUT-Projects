...
\projectinfo{
  ...
  title.cs={Analýza HTTPS zabezpečené komunikace},  %nazev prace v cestine ci slovenstine (dle zadani) / thesis title in czech language (according to assignment)
  title.en={Analysis of HTTPS secure communication}, %nazev prace v anglictine / thesis title in english
  %Autor / Author
...
\fi
  ...
  % ----------------------------------------------
  \input{manual-01-kapitoly-chapters} % viz. obsah.tex / see obsah.tex
